...
,(10,'list_manager','List Manager','1.1.1.0','WEB','http://10.211.55.5:8080/BreedingManager/main/germplasm-import/','',0)
,(11,'crossing_manager','Crossing Manager','1.2.0','WEB','http://10.211.55.5:8080/BreedingManager/main/crosses/','',0)
,(12,'nursery_template_wizard','Nursery Template Wizard','1.1.1.0','WEB','http://10.211.55.5:8080/BreedingManager/main/nursery-template/?restartApplication','',0)
,(13,'breeding_planner','Breeding Planner','1.0','NATIVE','C:\\IBWorkflowSystem\\tools/breeding_planner/breeding_planner.exe','',0)
,(14,'ibfb_germplasm_import','Fieldbook Germplasm Import','4.0.0','NATIVE','C:\\IBWorkflowSystem\\tools/fieldbook/IBFb/bin/ibfb.exe','--ibpApplication=GermplasmImport',0)
...
,(18,'dataset_importer','Data Import Tool','1.0','WEB','http://10.211.55.5:8080/DatasetImporter/','',0)
...
,(20,'breeding_view_wb','Single-Site Analysis','1.0','WORKBENCH','http://localhost:8080/ibpworkbench/main/#/breeding_view','',0)
,(21,'breeding_gxe','Multi-Site Analysis','1.0','WORKBENCH','http://localhost:8080/ibpworkbench/main/#/BreedingGxE','',0)
;
