...
INSERT INTO workbench_tool (name, title, version, tool_type, path) VALUES
 ('germplasm_browser', 'Browse Germplasm Information', '1.1.2.1', 'WEB', 'http://localhost:18080/GermplasmStudyBrowser/main/germplasm/')
,('study_browser', 'Browse Studies and Datasets', '1.1.2.1', 'WEB', 'http://localhost:18080/GermplasmStudyBrowser/main/study/')
,('germplasm_list_browser', 'Browse Germplasm Lists', '1.1.2.1', 'WEB', 'http://localhost:18080/GermplasmStudyBrowser/main/germplasmlist/')
